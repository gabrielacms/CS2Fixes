...
static std::unordered_map<std::string, WeaponInfo_t> s_WeaponMap = {
	...
	{"weapon_mac10",				 {"weapon_mac10", 17, 2, GEAR_SLOT_RIFLE, 1050, "MAC-10", {"mac10", "mac"}}						},
	...
	{"weapon_m4a1_silencer",		 {"weapon_m4a1_silencer", 60, 3, GEAR_SLOT_RIFLE, 2900, "M4A1-S", {"m4a1-s", "m4a1", "m4s"}}		 },
	...
	{"weapon_decoy",				 {"weapon_decoy", 47, 0, GEAR_SLOT_GRENADES, 40, "Decoy Grenade", {"decoy", "tagre", "bagre"}}		},
	...
	{"item_assaultsuit",			 {"item_assaultsuit", 51, 0, GEAR_SLOT_UTILITY, 650, "Kevlar & Helmet", {"kevlar", "kev", "colete"}}},
	{"item_kevlar",					{"item_kevlar", 50, 0, GEAR_SLOT_UTILITY}														 },
	{"item_heavyassaultsuit",		  {"item_heavyassaultsuit", 52, 0, GEAR_SLOT_UTILITY}												 },
	{"item_defuser",				 {"item_defuser", 55, 0, GEAR_SLOT_UTILITY}														    },
	{"weapon_healthshot",			 {"weapon_healthshot", 57, 0, GEAR_SLOT_UTILITY, 1000, "Healthshot", {"hs", "hshot", "healthshot"}}},
